...
function generateRickProfile(la) {
  ...
  var md = nameAndTitle.search("md");
  var md1 = nameAndTitle.search("m.d");

  var dr = nameAndTitle.search("dr");

  var phd = nameAndTitle.search("phd");
  var phd2 = nameAndTitle.search("Ph.d");
  ...
  var summaryText = hightlightText`Dear ${la.ApplicantName} ,

    your application for ${"$" + la.LoanAmount},${reviewText}

    Your risk profile is ${riskProfile},

    your unique application code is \t${create_UUID()}`;
